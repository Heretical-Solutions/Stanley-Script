...
namespace UImGui
{
	...
	public struct FontConfig
	{
		...
		public void ApplyTo(ImFontConfigPtr im)
		{
			...
			im.GlyphExtraSpacing = GlyphExtraSpacing.ToNumericsVector2();
			im.GlyphOffset = GlyphOffset.ToNumericsVector2();
		...
		public void SetFrom(ImFontConfigPtr im)
		{
			...
			GlyphExtraSpacing = im.GlyphExtraSpacing.ToUnityVector2();
			GlyphOffset = im.GlyphOffset.ToUnityVector2();
