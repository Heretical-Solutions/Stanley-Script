...
namespace UImGui.Assets
{
	...
	public class StyleAsset : ScriptableObject
	{
		...
		public unsafe void ApplyTo(ImGuiStylePtr s)
		{
			...
			s.WindowPadding = WindowPadding.ToNumericsVector2();
			s.WindowRounding = WindowRounding;
			s.WindowBorderSize = WindowBorderSize;
			s.WindowMinSize = WindowMinSize.ToNumericsVector2();
			s.WindowTitleAlign = WindowTitleAlign.ToNumericsVector2();
			...
			s.FramePadding = FramePadding.ToNumericsVector2();
			s.FrameRounding = FrameRounding;
			s.FrameBorderSize = FrameBorderSize;

			s.ItemSpacing = ItemSpacing.ToNumericsVector2();
			s.ItemInnerSpacing = ItemInnerSpacing.ToNumericsVector2();

			s.CellPadding = CellPadding.ToNumericsVector2();

			s.TouchExtraPadding = TouchExtraPadding.ToNumericsVector2();
			...
			s.ButtonTextAlign = ButtonTextAlign.ToNumericsVector2();

			s.SelectableTextAlign = SelectableTextAlign.ToNumericsVector2();

			s.DisplayWindowPadding = DisplayWindowPadding.ToNumericsVector2();
			s.DisplaySafeAreaPadding = DisplaySafeAreaPadding.ToNumericsVector2();
			...
			{
				s.Colors[colorIndex] = Colors[colorIndex].ToNumericsVector4();
			}
		}
		...
		public unsafe void SetFrom(ImGuiStylePtr s)
		{
			...
			WindowPadding = s.WindowPadding.ToUnityVector2();
			WindowRounding = s.WindowRounding;
			WindowBorderSize = s.WindowBorderSize;
			WindowMinSize = s.WindowMinSize.ToUnityVector2();
			WindowTitleAlign = s.WindowTitleAlign.ToUnityVector2();
			...
			FramePadding = s.FramePadding.ToUnityVector2();
			FrameRounding = s.FrameRounding;
			FrameBorderSize = s.FrameBorderSize;

			ItemSpacing = s.ItemSpacing.ToUnityVector2();
			ItemInnerSpacing = s.ItemInnerSpacing.ToUnityVector2();

			CellPadding = s.CellPadding.ToUnityVector2();

			TouchExtraPadding = s.TouchExtraPadding.ToUnityVector2();
			...
			ButtonTextAlign = s.ButtonTextAlign.ToUnityVector2();

			SelectableTextAlign = s.SelectableTextAlign.ToUnityVector2();

			DisplayWindowPadding = s.DisplayWindowPadding.ToUnityVector2();
			DisplaySafeAreaPadding = s.DisplaySafeAreaPadding.ToUnityVector2();
			...
			for (int colorIndex = 0; colorIndex < Colors.Length; ++colorIndex)
			{
				Colors[colorIndex] = s.Colors[colorIndex].ToUnityColor();
			}
		}
