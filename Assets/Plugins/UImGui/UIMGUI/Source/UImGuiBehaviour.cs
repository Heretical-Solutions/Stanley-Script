...
namespace UImGui
{
	...
	public class UImGuiBehaviour : MonoBehaviour
	{
		...
		[SerializeField]
		private bool _scaleWithScreen = true;
		...
		#region Events
		public event System.Action<UImGuiBehaviour> Layout;
		public event System.Action<UImGuiBehaviour> OnInitialize;
		public event System.Action<UImGuiBehaviour> OnDeinitialize;
		#endregion
