...
namespace UImGui
{
	public static class UImGuiUtility
	{
		...
		#region Events
		public static event Action<UImGuiBehaviour> Layout;
		public static event Action<UImGuiBehaviour> OnInitialize;
		public static event Action<UImGuiBehaviour> OnDeinitialize;
		internal static void DoLayout(UImGuiBehaviour uimgui) => Layout?.Invoke(uimgui);
		internal static void DoOnInitialize(UImGuiBehaviour uimgui) => OnInitialize?.Invoke(uimgui);
		internal static void DoOnDeinitialize(UImGuiBehaviour uimgui) => OnDeinitialize?.Invoke(uimgui);
		#endregion
